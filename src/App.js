      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 to-blue-700 p-4">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <div className="bg-white rounded-xl p-5">
            ...
            <div className="mb-4 rounded-lg border border-blue-200 bg-blue-50 p-4">
              <p className="text-sm leading-relaxed text-blue-900">
                This simulation places you in the role of a construction planner responsible for scheduling a major water pipeline project. Over five rounds, you will explore how crew productivity, spacing (buffers), and activity sequencing influence progress using the Line of Balance (LOB) method. Your goal is to build a feasible schedule, avoid crew conflicts, and optimize both duration and cost—just like a real project engineer.
              </p>
            </div>
          ...
          <div className="bg-white rounded-xl p-5">
            ...
            <div className="mb-4 rounded-lg border border-blue-200 bg-blue-50 p-4">
              <p className="text-sm leading-relaxed text-blue-900">
                This project uses three sequential pipeline crews—Excavation, Pipe Laying, and Backfill—each with its own productivity and equipment. Understanding their roles helps you plan start times, avoid overlap, and create a conflict-free Line of Balance (LOB) schedule.
              </p>
            </div>
            <div className="space-y-3">
              <details className="group rounded-lg border border-blue-200 bg-blue-50 p-4">
                ...
                <p className="mt-3 text-sm leading-relaxed text-blue-900">
                  Crew A uses an <strong>Excavator</strong> to dig the trench and prepare the bedding. As the first crew in sequence, it sets the pace for all other crews and must stay ahead to avoid delaying pipeline installation.
                </p>
              </details>
              ...
              <details className="group rounded-lg border border-green-200 bg-green-50 p-4">
                ...
                <p className="mt-3 text-sm leading-relaxed text-green-900">
                  Crew B uses a <strong>Mobile Crane</strong> to lift and align pipe sections in the trench prepared by Crew A. They progress more slowly, so maintaining proper spacing helps prevent bottlenecks in the workflow.
                </p>
              </details>
              ...
              <details className="group rounded-lg border border-orange-200 bg-orange-50 p-4">
                ...
                <p className="mt-3 text-sm leading-relaxed text-orange-900">
                  Crew C uses a <strong>Backfill Set</strong> (Excavator + Compactor) to place and compact soil over installed pipes. They often work faster than pipe laying, so proper spacing prevents them from catching up and causing conflicts.
                </p>
              </details>
            </div>
              ...
              <div className="bg-white rounded-lg shadow p-4">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { name: 'Excavation & Bedding', s: r1Student.excS, e: r1Student.excE, c: 'bg-blue-500' },
                    { name: 'Pipe Laying & Alignment', s: r1Student.pipeS, e: r1Student.pipeE, c: 'bg-green-500' },
                    { name: 'Backfill & Compaction', s: r1Student.backS, e: r1Student.backE, c: 'bg-orange-500' }
                  ].map((bar, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <div className="w-24 text-xs text-right">{bar.name}</div>
                      <div className="flex-1 h-6 bg-gray-100 rounded relative">
                        {bar.s > 0 && bar.e > 0 && (
                          <div
                            ...
                            style={{
                              left: `${(bar.s / 150) * 100}%`,
                              width: `${Math.max(((bar.e - bar.s + 1) / 150) * 100, 3)}%`
                            }}
                          >
                            {bar.s}-{bar.e}
                          </div>
          ...
          <>
            ...
            <div className="bg-white rounded-lg shadow p-4">
              ...
              <div className="mt-2 p-2 bg-red-50 border border-red-200 rounded text-sm text-red-700">
                ⚠️ The LOB from R1 must be revised.
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="bg-blue-50 p-3 rounded">
                  <strong>Simple Buffer</strong> (slower follows faster): <code>Start = Prev Start + Buffer</code>
                </div>
                <div className="bg-orange-50 p-3 rounded">
                  <strong>Delayed Buffer</strong> (faster follows slower): <code>Start = Prev End + Buffer - Duration + 1</code>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-4">
              ...
              {r2Validated && !r2IsCorrect && (
                <div className="mt-2 p-2 bg-red-100 text-red-700 rounded">❌ Some answers incorrect. Try again.</div>
              )}
              {r2Validated && r2IsCorrect && (
                <div className="mt-2 p-2 bg-green-100 text-green-700 rounded">✅ All correct!</div>
              )}
            </div>
        ...
        {round === 3 && (
          <>
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <p className="text-sm">See how buffer affects duration.</p>
            </div>
            ...
            <div className="bg-yellow-50 p-4 rounded">
              <strong>💡 Key Insight:</strong> Buffer ↑ = Duration ↑, but Cost stays the same!
            </div>
        ...
        {round === 4 && (
          <>
            <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded">
              ...
              <p className="text-sm">Select equipment type (1 unit each).</p>
            </div>
              ...
              <table className="w-full text-sm border">
                <thead className="bg-gray-100">
                  <tr>
                    ...
                    <th className="px-2 py-1 border">Rate (ft/day)</th>
                    <th className="px-2 py-1 border">Duration (days)</th>
                ...
                <tbody>
                  ...
                  <tr className="text-blue-700">
                    <td className="px-2 py-1 border">Excavation & Bedding</td>
                  ...
                  <tr className="text-green-700">
                    <td className="px-2 py-1 border">Pipe Laying & Alignment</td>
                  ...
                  <tr className="text-orange-700">
                    <td className="px-2 py-1 border">Backfill & Compaction</td>
        ...
        {round === 5 && (
          <>
            <div className="bg-purple-50 border-l-4 border-purple-500 p-4 rounded">
              ...
              <p className="text-sm">Meet constraints: ≤{TARGET_DAYS} days and ≤${TARGET_COST.toLocaleString()}</p>
            </div>
                      ...
                      return (
                        <div key={key} className="flex items-center justify-between bg-white p-2 rounded mb-1">
                          ...
                          <div className="flex items-center gap-1">
                            <button
                              onClick={() => setR5Config(p => ({...p, [type]: {...p[type], [key]: Math.max(0, p[type][key] - 1)}}))}
                            ...
                            <button
                              onClick={() => setR5Config(p => ({...p, [type]: {...p[type], [key]: p[type][key] + 1}}))}
                              className="w-6 h-6 bg-blue-200 rounded font-bold"
                            >
                              +
                            </button>
                          </div>
